        ...
        <div class="row">
            <div class="col-md-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                    <?php echo form_open_multipart('administrator/suratkeluar/tambah_sk_aksi') ?>
                    ...
                    <div class="row">
                            <div class='col-sm-6'>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="tujuan" placeholder="Masukan Tujuan" maxlength="100" required oninvalid="this.setCustomValidity('Masukan Tujuan')" oninput="setCustomValidity('')">
