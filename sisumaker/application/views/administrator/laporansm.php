    ...
    <?php
        ...
        <?php } ?>
                    ...
                    <table id="datatable-keytable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <?php 
                      $no = 1;
                      foreach ($lapsuratmasuk as $lsm) : ?>
                      <tr>
                          <td width="20px"><?php echo $no++ ?></td>
                          <td><?php echo tgl_indo($lsm->tgl_terima) ?></td>
                          <td><?php echo $lsm->pengirim ?></td>
                          <td><?php echo $lsm->nosurat ?></td>
                          <td><?php echo $lsm->ringkasan ?></td>
                          <td><?php echo $lsm->pejabat ?></td>
                      </tr>
                        <?php  endforeach; ?>
                      </tbody>
