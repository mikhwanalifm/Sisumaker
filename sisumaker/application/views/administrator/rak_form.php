                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                       <form method="post" action ="<?php echo base_url('administrator/rak/tambah_rak_aksi')?>">
                                ...
                                <div class="form-group">
                                    <label>Id File</label>
                                    <input type="text" id="id_file" readonly class="form-control" name="id_file" placeholder="..." maxlength="3" onkeyup="this.value = this.value.toUpperCase()" required oninvalid="this.setCustomValidity('Masukan Angka Saja')" oninput="setCustomValidity('')">
                                </div>
                                    </div>
