            ...
            <div class="col-md-12">
                <div class="x_panel">
                    ...
                    <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="pengirim" readonly value="<?php echo $sm->pengirim ?>" placeholder="Masukan Pengirim" maxlength="100" required oninvalid="this.setCustomValidity('Masukan Pengirim')" oninput="setCustomValidity('')">
                                </div>
