...
<div class="right_col" role="main">
  <div class="x_title">
                    <h2>Laporan Agenda Surat Tugas</h2>
        ...
        <!-- <a href="<?php echo base_url('administrator/laporansm'); ?>"><button type="submit" class="btn btn-sm btn-info" ><i class="fa fa-refresh"> Reset</i></button></a> -->
    </form>
    <hr />
    ...
    <?php
        ...
        <?php } ?>
                    ...
                    <table id="datatable-keytable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <?php 
                      $no = 1;
                      foreach ($lapsuratugas as $lega) : ?>
                      <tr>
                          <td width="20px"><?php echo $no++ ?></td>
                          <td><?php echo tgl_indo($lega->tgl_keluar) ?></td>
                          <td><?php echo $lega->nosurat ?></td>
                          <td><?php echo tgl_indo($lega->tmt) ?></td>
                          <td><?php echo $lega->pengelola ?></td>
                          <td><?php echo word_limiter($lega->keterangan,10) ?></td>
                      </tr>
                        <?php  endforeach; ?>
                      </tbody>
