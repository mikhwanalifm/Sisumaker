...
<script>
        $(document).ready(function(){
            $("#lemari").change(function (){
                var url = "<?php echo site_url('administrator/suratmasuk/add_ajax_rak');?>/"+$(this).val();
                $('#rak').load(url);
                return false;
            })
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                    <?php echo form_open_multipart('administrator/suratmasuk/tambah_sm_aksi') ?>
                                <div class="form-group">
                                    <label>Pengirim</label>
                                    <input type="text" class="form-control text-capitalize" name="pengirim" placeholder="Masukan Pengirim" maxlength="100" required oninvalid="this.setCustomValidity('Masukan Pengirim')" oninput="setCustomValidity('')">
                                </div>
