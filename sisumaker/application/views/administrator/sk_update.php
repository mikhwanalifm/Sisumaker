        ...
        <div class="row">
            <div class="col-md-12">
                <div class="x_panel">
                    ...
                    <?php echo form_open_multipart('administrator/suratkeluar/update_aksi') ?>
                    ...
                    <div class="row">
                            <div class='col-sm-6'>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" readonly name="tujuan" value="<?php echo $sk->tujuan ?>" placeholder="Masukan Tujuan" maxlength="100" required oninvalid="this.setCustomValidity('Masukan Pengirim')" oninput="setCustomValidity('')">
