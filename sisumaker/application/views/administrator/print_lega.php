  ...
  <img src="<?php echo base_url() ?>assets4/uploads/icon/kop.png" width="100%">
    ...
    <table width="1000px" class="text-center">
      <tr align='center'>
        ...
        <th style="border: 1px solid black; padding: 5px;" width="20%">No. Register</th>
        <th style="border: 1px solid black; padding: 5px;" width="10%">Tanggal Keluar</th>
        <th style="border: 1px solid black; padding: 5px;" width="10%">Alamat</th>
        <th style="border: 1px solid black; padding: 5px;" width="10%">Keterangan</th>
      ...
      <?php 
        ...
        <tr align="center">
          ...
          <td style="border: 1px solid black; padding: 5px;"><?php echo $data->nama?></td>
          <td style="border: 1px solid black; padding: 5px;"><?php echo $data->noreg?></td>
          <td style="border: 1px solid black; padding: 5px;"><?php echo tgl_indo($data->tgl_keluar)?></td>
          <td style="border: 1px solid black; padding: 5px;"><?php echo $data->alamat?></td>
          <td style="border: 1px solid black; padding: 5px;"><?php echo $data->keterangan?></td>
        </tr>
        <?php endforeach; ?>
    </table>
    <br>
