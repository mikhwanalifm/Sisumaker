  ...
  <img src="<?php echo base_url() ?>assets4/uploads/icon/kop.png" width="100%">
    ...
    <table width="1000px" class="text-center">
      <tr align='center'>
        ...
        <th style="border: 1px solid black" width="20%">No. Surat</th>
        <th style="border: 1px solid black" width="10%">TMT</th>
        <th style="border: 1px solid black" width="10%">Pengelola</th>
        <th style="border: 1px solid black" width="10%">Keterangan</th>

      </tr>
      <?php 
        $no = 1;
        foreach ($lapsuratugas as $data) : ?>
        <tr align="center">
          ...
          <td style="border: 1px solid black"><?php echo tgl_indo($data->tmt)?></td>
          <td style="border: 1px solid black"><?php echo $data->pengelola?></td>
