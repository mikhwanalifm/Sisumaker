  ...
  <img src="<?php echo base_url() ?>assets4/uploads/icon/kop.png" width="100%">
    ...
    <table width="1000px" class="text-center">
      <tr align='center'>
        ...
        <th style="border: 1px solid black" width="10%">Tanggal</th>
        <th style="border: 1px solid black" width="20%">Nomor Surat</th>
        <th style="border: 1px solid black" width="10%">Pengirim</th>
        <th style="border: 1px solid black" width="10%">Ringkasan</th>
      ...
      <?php 
        ...
        <tr align="center">
          ...
          <td style="border: 1px solid black"><?php echo tgl_indo($data->tgl_terima)?></td>
          <td style="border: 1px solid black"><?php echo $data->nosurat?></td>
          <td style="border: 1px solid black"><?php echo $data->pengirim?></td>
          <td style="border: 1px solid black"><?php echo $data->ringkasan?></td>
        </tr>
        <?php endforeach; ?>
    </table>
    <br>
