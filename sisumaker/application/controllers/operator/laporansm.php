...
class Laporansm extends CI_Controller {
  ...
  public function index(){
        if(isset($_GET['filter']) && ! empty($_GET['filter'])){ // Cek apakah user telah memilih filter dan klik tombol tampilkan
            ...
            if($filter == '1'){ // Jika filter nya 1 (per tanggal)
                ...
                $url_cetak = 'operator/laporansm/cetak?filter=1&tahun='.$tgl;
                ...
                $url_cetak = 'operator/laporansm/cetak?filter=2&bulan='.$bulan.'&tahun='.$tahun;
                ...
                $url_cetak = 'operator/laporansm/cetak?filter=3&tahun='.$tahun;
            ...
            $url_cetak = 'operator/laporansm/cetak';
    ...
    $this->load->view('operator/laporansm', $data);
  ...
  public function cetak(){
    ...
    $this->load->view('operator/print_sm1',$data);
      //  ob_end_clean();
