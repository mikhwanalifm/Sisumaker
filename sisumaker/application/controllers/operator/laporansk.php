...
class Laporansk extends CI_Controller {
  ...
  public function index(){
        if(isset($_GET['filter']) && ! empty($_GET['filter'])){ // Cek apakah user telah memilih filter dan klik tombol tampilkan
            ...
            if($filter == '1'){ // Jika filter nya 1 (per tanggal)
                ...
                $url_cetak = 'operator/laporansk/cetak?filter=1&tahun='.$tgl;
                ...
                $url_cetak = 'operator/laporansk/cetak?filter=2&bulan='.$bulan.'&tahun='.$tahun;
                ...
                $url_cetak = 'operator/laporansk/cetak?filter=3&tahun='.$tahun;
            ...
            $url_cetak = 'operator/laporansk/cetak';
    ...
    $this->load->view('operator/laporansk', $data);
  ...
  public function cetak(){
    ...
    //ob_start();
    //$html = $this->load->view('operator/print_sk',$data, TRUE);
    $this->load->view('operator/print_sk1',$data);
      //  ob_end_clean();
