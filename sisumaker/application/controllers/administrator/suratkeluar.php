...
class Suratkeluar extends CI_Controller{
	...
	public function index()
	{
		...
		$data['suratkeluar'] = $this->db->query("SELECT * FROM tb_suratkeluar ORDER BY tgl_keluar ASC")->result();
	...
	{	$data = $this->user_model->ambil_data($this->session->userdata['username']);
		...
		$this->load->view('template_admins/header');
		$this->load->view('template_admins/sidebar');
		$this->load->view('administrator/sk_form',$data);
		$this->load->view('template_admins/footer');
	}
	...
	public function tambah_sk_aksi()
	{
		...
		if($this->form_validation->run()==FALSE){
			...
			$this->session->set_flashdata('pesan','  Gagal, Surat Sudah Ada!');
			 redirect('administrator/suratkeluar');
			 }
	...
	public function update($id)
	{
		...
		$this->load->view('template_admins/header');
		$this->load->view('template_admins/sidebar');
		$this->load->view('administrator/sk_update',$data);
		$this->load->view('template_admins/footer');
	}
	...
	public function detail($kode)
		{
			...
			$this->load->view('template_admins/header');
			$this->load->view('template_admins/sidebar');
			$this->load->view('administrator/sk_details',$data);
			$this->load->view('template_admins/footer');
		}
