...
class Laporanst extends CI_Controller {
  ...
  public function index(){
        if(isset($_GET['filter']) && ! empty($_GET['filter'])){ // Cek apakah user telah memilih filter dan klik tombol tampilkan
            ...
            if($filter == '1'){ // Jika filter nya 1 (per tanggal)
                ...
                $url_cetak = 'administrator/laporanst/cetak?filter=1&tahun='.$tgl;
                ...
                $url_cetak = 'administrator/laporanst/cetak?filter=2&bulan='.$bulan.'&tahun='.$tahun;
                ...
                $url_cetak = 'administrator/laporanst/cetak?filter=3&tahun='.$tahun;
            ...
            $url_cetak = 'administrator/laporanst/cetak';
    ...
    $this->load->view('administrator/laporanst', $data);
  ...
  public function cetak(){
    ...
    $this->load->view('administrator/print_st',$data);
      //  ob_end_clean();
